      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="max-w-md w-full mx-4">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Please generate documentation first by uploading a README file.</p>
            <Link href="/">
              <Button>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div className="hidden sm:block">
                <h1 className="font-semibold text-gray-900">{projectData.name}</h1>
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-600">
                  Generated on {new Date(projectData.generatedAt).toLocaleDateString()}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-white p-3 rounded-lg border">
                  <div className="text-2xl font-bold text-gray-900">{projectData.content.split("\n").length}</div>
                  <div className="text-xs text-gray-600">Lines</div>
                </div>
                <div className="bg-white p-3 rounded-lg border">
                  <div className="text-2xl font-bold text-gray-900">{projectData.content.split("#").length - 1}</div>
            ...
            <div className="mb-8 pb-8 border-b border-gray-200">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-gray-600">Professional documentation generated from README</p>
                </div>
            ...
            <div className="mt-16 pt-8 border-t border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right text-sm text-gray-600">
                  <p>Generated: {new Date(projectData.generatedAt).toLocaleString()}</p>
